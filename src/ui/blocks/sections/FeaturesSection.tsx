...
// TODO: refactor most of classes and improve this component
      ...
      <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div className="flex flex-col lg:flex-row lg:items-center space-y-12 lg:space-y-0 lg:space-x-20">
          ...
          <div className="lg:w-5/12 xl:w-5/12 md:py-12 space-y-10">
            <div>
              <div className="text-sm uppercase font-bold tracking-wider mb-1 text-indigo-700">It’s time to build</div>
              <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Amazing features packed in a neat package</h2>
              ...
              <div className="md:w-1/2 md:mt-24 space-y-6">
                <div className="group bg-white p-5 transition ease-out duration-200 border-2 border-gray-200 rounded-2xl hover:border-orange-300">
                  ...
                  <p className="leading-relaxed text-gray-600">
                    Fusce purus nisi, gravida sed consectetur ut, interdum quis nisi. Quisque egestas nisl id lectus
                    facilisis scelerisque. Proin rhoncus dui at ligula vestibulum ut facilisis.
                  </p>
                </div>
