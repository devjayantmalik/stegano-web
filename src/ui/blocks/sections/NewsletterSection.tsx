...
export const NewsletterSection: React.FC<INewsletterSectionProps> = () => {
  return (
    <section className="overflow-hidden">
      <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div className="lg:w-2/3 xl:w-1/2 mx-auto relative">
          <div className="absolute pattern-dots-xl text-gray-200 top-0 left-0 w-32 h-48 md:h-96 transform -translate-y-12 -translate-x-16 -rotate-3" />
          <div className="absolute pattern-dots-xl text-gray-200 bottom-0 right-0 w-32 h-48 md:h-96 transform translate-y-12 translate-x-16 rotate-3" />
          ...
          <div className="p-2 rounded text-center relative bg-indigo-500 bg-opacity-10">
            <div className="p-8 lg:py-12 lg:px-16 bg-white rounded">
              <h3 className="text-2xl sm:text-3xl font-extrabold mb-2">Subscribe to our newsletter</h3>
              ...
              <form onsubmit="return false;" className="space-y-3">
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    <svg
                      ...
                      className="sm:hidden hi-outline hi-plus inline-block w-6 h-6">
                      <path
                        strokeLinecap="round"
                ...
                <p className="text-sm text-gray-600 leading-6">
                  ...
                  Check out our{" "}
                  <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-400">
                    Privacy Policy
                  </a>
                  .
                </p>
